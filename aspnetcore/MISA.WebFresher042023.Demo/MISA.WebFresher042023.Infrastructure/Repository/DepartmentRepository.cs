    ...
    public class DepartmentRepository : BaseRepository<Department>, IDepartmentRepository
    {
        ...
        public async Task<IEnumerable<Department>?> GetByName(string? textSearch)
        {
            ...
            try
            {
                ...
                var res = await _unitOfWork.Connection.QueryAsync<Department>("Proc_Department_GetByName", parameters, commandType: CommandType.StoredProcedure, transaction: _unitOfWork.Transaction);
                return res;
            }
            catch
            {
