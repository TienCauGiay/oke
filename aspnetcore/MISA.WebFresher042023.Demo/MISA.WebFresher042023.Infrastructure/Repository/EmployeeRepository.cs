...
namespace MISA.WebFresher042023.Infrastructure.Repository
{
    ...
    public class EmployeeRepository : BaseRepository<Employee>, IEmployeeRepository
    {
        ...
        public async Task<string?> GetByCodeMaxAsync()
        {
            try
            {
                var res = await _unitOfWork.Connection.QueryFirstOrDefaultAsync<string>("Proc_Employee_GetCodeMax", commandType: CommandType.StoredProcedure, transaction: _unitOfWork.Transaction);
        ...
        public async Task<FilterEmployee?> GetFilterAsync(int pageSize, int pageNumber, string? textSearch)
        {
            try
            {
                ...
                var result = await _unitOfWork.Connection.QueryAsync<Employee>("Proc_Employee_GetFilter", parameters, commandType: CommandType.StoredProcedure, transaction: _unitOfWork.Transaction);
