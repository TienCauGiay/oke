...
namespace MISA.WebFresher042023.Core.Interfaces.Services
{
    ...
    public interface IAccountService : IBaseService<AccountDto, AccountCreateDto, AccountUpdateDto>
    {
        ...
        /// Created By: BNTIEN (19/07/2023)
        Task<FilterAccountDto?> GetFilterAsync(int pageSize, int pageNumber, string? textSearch, int isRoot, int grade, string? accountNumber);
        ...
        Task<List<AccountDto>?> GetAllChildrenAsync(string accountNumber);
